...
/** List helpers the generated bytecode calls (spec §stdlib-list). A {@code List} value is a
...
public final class Lists {
    ...
    /** Immutable concatenation of two lists (spec §stdlib-list, the {@code ++} operator). Grows a
