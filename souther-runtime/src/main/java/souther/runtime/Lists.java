...
public final class Lists {
    ...
    @SuppressWarnings({"unchecked", "rawtypes"})
    public static <T> List<T> sortBy(Comparator<Object> by, Fn key, List<? extends T> xs) {
    ...
    @SuppressWarnings({"unchecked", "rawtypes"})
    private static <T> Option<T> extreme(List<? extends T> xs, Comparator<Object> by, boolean greatest) {
        if (xs.isEmpty()) {
            return Option.none();
        }
        T best = xs.get(0);
