 ...
 * {@code Ordering} finds one for seven primitives, a value one enumeration orders, and a newtype
 * over either, and for nothing else); ordering by what is written instead is defined for
