...
class TheRuleAnswersEveryBoundaryTheGrammarCanBuildTest {
    ...
    private static final List<Face> DOMAIN = List.of(
            ...
            new Face(FN_DEF, of(LET_KW), of(IDENT)),
            new Face(FN_DEF, of(CONTEXTUAL_KW), of(CONTEXTUAL_KW, LET_KW)),
            new Face(FN_DEF, of(ASSIGN), of(CONTEXTUAL_KW)),
            ...
            new Face(DEPENDS_CLAUSE, of(DEPENDS_KW), of(CONTEXTUAL_KW)),
            new Face(DEPENDS_CLAUSE, of(CONTEXTUAL_KW, COMMA), of(IDENT)),
            ...
            new Face(INTRINSIC_BODY, of(CONTEXTUAL_KW), of(STRING_LIT)),
            ...
            new Face(EXAMPLES_FILE_HEADER, of(CONTEXTUAL_KW), of(CONTEXTUAL_KW, IDENT)),
            new Face(EXAMPLE_DEF, of(CONTEXTUAL_KW), of(IDENT)),
            ...
            new Face(FAKE_DEF, of(CONTEXTUAL_KW), of(IDENT)),
