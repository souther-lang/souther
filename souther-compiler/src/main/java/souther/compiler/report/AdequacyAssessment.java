 ...
 * its own out again from the parts the projection kept rather than selecting from these, so no
 * containment between two scopes is promised here — what each holds is what its own parts came to
