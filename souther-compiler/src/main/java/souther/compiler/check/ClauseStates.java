 ...
 * {@link RuleKey} and a line it draws is a {@link FieldDomains.Coordinate}, which are what a reading
...
sealed interface ClauseStates {
     ...
     */
    record ABound(FieldDomains.Coordinate line, Set<RuleKey> named) implements ClauseStates {
