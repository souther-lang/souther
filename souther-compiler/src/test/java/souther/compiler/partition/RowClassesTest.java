...
class RowClassesTest {
    ...
    void aRowsValuesAreReadBackIntoTheClassesTheyFellIn() {
        ...
        assertEquals(new Classification.Classified(List.of("Domestic")), at(classes, "request.kind"));
    ...
    void aValueOnTheOtherSideOfAThresholdFallsInTheOtherClass() {
        ...
        assertEquals(new Classification.Classified(List.of("Overseas")), at(classes, "request.kind"));
        assertEquals(new Classification.Classified(List.of("request.cost/100 < x")),
                at(classes, "request.cost"));
    }
