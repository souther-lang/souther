...
class WhyAValueCouldNotBePlacedIsTheClassifiersToSayTest {
    ...
    private static Read read() {
        ...
        Partitions.Partitioning partitioning = Partitions.withThresholds(
                ...
                compilation.db().ask(new souther.compiler.query.Adequacy.Inputs(module)).value().get("submit"), symbols).thresholds(), symbols, souther.compiler.check.ReadAs.THE_COMPILATION_DOES);
