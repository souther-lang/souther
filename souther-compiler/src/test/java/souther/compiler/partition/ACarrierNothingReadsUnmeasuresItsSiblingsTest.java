...
class ACarrierNothingReadsUnmeasuresItsSiblingsTest {
    ...
    private static Read read(String source, String behavior) {
        ...
        return new Read(Partitions.of(spec.name(), InputDomain.of(spec, sigs.get(behavior), symbols, souther.compiler.check.ReadAs.THE_COMPILATION_DOES), symbols, souther.compiler.check.ReadAs.THE_COMPILATION_DOES), symbols);
    }
}
