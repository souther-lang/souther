...
a temporal parsed from its ISO form) and encoding it back bare. Widened by ADR-0103: the temporal
set is four — `Date`, `Time`, `DateTime`, `Instant` — not the two this reasons about.
